---
# このファイルをコピーして「作品名.md」で保存すると、制作物が1件増えます。
# ファイル名がそのまま URL になります（例: haniwa-dance.md → /works/haniwa-dance/）。
# 「_」で始まるファイルは無視されるので、このテンプレートは表示されません。

title: 作品のタイトル
org: 依頼元・展示先（例：福島県立博物館）
date: 2026-01-01 # 並び順に使います。新しいほど上に出ます
...
# 自分で画像を用意する場合だけ、public/works/ に置いてパスを書いてください。
thumbnail: # /works/sakuhin.jpg

# 動画。YouTube / Google Drive の URL をそのまま貼るだけで大丈夫です（埋め込み用に自動で変換されます）
# Drive は「リンクを知っている全員」に共有しておいてください
videos:
  # - title: プレイ映像
  #   url: https://www.youtube.com/watch?v=XXXXXXXXXXX

# スクリーンショット。public/works/ に置いてください
gallery:
...
draft: true # 書きかけの間は true。false にすると公開されます
---

## 概要

ここに Markdown で本文を書きます。見出し、画像、箇条書き、コードブロックが使えます。
